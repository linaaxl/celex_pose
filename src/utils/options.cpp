...
Utils::Options::Parser::Parser(int argc, char **argv){
    ...
    general_opt.add_option("--celex-file",
            [this](const std::string &arg){
                current_setup.cam_config.use_celex = true;
                current_setup.cam_config.celex_file = arg;
            },
  "Use CeleX raw file instead of Metavision .raw");
    po::variables_map vm;
